    ...
    public class FuturesUMMarketApiClient : FuturesUMClientBase
    {
        ...
        private FuturesExchangeInfo ParseExchangeInfoResponse(byte[] data, object parsingArgs)
        {
            ...
            if (!validator.IsComplete())
            {
                ...
                switch (missingPropNum)
                {
                    ...
                    case 3: throw ParseUtility.GenerateMissingPropertyException(objName, "assets");
                    case 4: throw ParseUtility.GenerateMissingPropertyException(objName, "symbols");
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
            {
                ...
                if (!validator.IsComplete())
                {
                    ...
                    switch (missingPropNum)
                    {
                        ...
                        case 1: throw ParseUtility.GenerateMissingPropertyException(objName, "is margin available");
                        case 2: throw ParseUtility.GenerateMissingPropertyException(objName, "auto asset exchange");
                        default: throw ParseUtility.GenerateMissingPropertyException(objName, $"unknown ({missingPropNum})");
                    }
                }
                ...
                try
                {
                    ...
                    if (!validator.IsComplete())
                    {
                        ...
                        switch (missingPropNum)
                        {
                            ...
                            case 6: throw ParseUtility.GenerateMissingPropertyException(objName, "base asset");
                            case 7: throw ParseUtility.GenerateMissingPropertyException(objName, "quote asset");
                            case 8: throw ParseUtility.GenerateMissingPropertyException(objName, "margin asset");
                            case 9: throw ParseUtility.GenerateMissingPropertyException(objName, "price precision");
                            case 10: throw ParseUtility.GenerateMissingPropertyException(objName, "quantity precision");
                            case 11: throw ParseUtility.GenerateMissingPropertyException(objName, "base asset precision");
                            case 12: throw ParseUtility.GenerateMissingPropertyException(objName, "quote asset precision");
                            case 13: throw ParseUtility.GenerateMissingPropertyException(objName, "trigger protection threshold");
                            case 14: throw ParseUtility.GenerateMissingPropertyException(objName, "filters");
                            case 15: throw ParseUtility.GenerateMissingPropertyException(objName, "order types");
                            case 16: throw ParseUtility.GenerateMissingPropertyException(objName, "time-in-force rules");
                            case 17: throw ParseUtility.GenerateMissingPropertyException(objName, "liquidation fee");
                            case 18: throw ParseUtility.GenerateMissingPropertyException(objName, "market take bound");
                            case 19: throw ParseUtility.GenerateMissingPropertyException(objName, "max move order limit");
                            default: throw ParseUtility.GenerateMissingPropertyException(objName, $"unknown ({missingPropNum})");
                        }
                    }
        ...
        private PremiumInfo ParsePremiumInfo(ref Utf8JsonReader reader, ref ParseSchemaValidator validator)
        {
            ...
            if (!validator.IsComplete())
            {
                ...
                {
                    case 0: throw ParseUtility.GenerateMissingPropertyException(objName, "symbol");
                    case 1: throw ParseUtility.GenerateMissingPropertyException(objName, "mark price");
                    case 2: throw ParseUtility.GenerateMissingPropertyException(objName, "index price");
                    case 3: throw ParseUtility.GenerateMissingPropertyException(objName, "estim settlement price");
                    case 4: throw ParseUtility.GenerateMissingPropertyException(objName, "last funding rate");
                    case 5: throw ParseUtility.GenerateMissingPropertyException(objName, "next funding time");
                    case 6: throw ParseUtility.GenerateMissingPropertyException(objName, "interest rate");
                    case 7: throw ParseUtility.GenerateMissingPropertyException(objName, "timestamp");
                    default: throw ParseUtility.GenerateMissingPropertyException(objName, $"unknown {missingPropNum}");
                }
            }

            return new PremiumInfo(symbol, symbol, markPrice, indexPrice, settlePrice, lastFundRate, interestRate, nextFundTime, timestamp);
        }
        ...
        private OpenInterest ParseSingleOpenInterest(byte[] data, object parseArgs)
        {
            ...
            if (!validator.IsComplete())
            {
                ...
                {
                    case 0: throw ParseUtility.GenerateMissingPropertyException(objName, "symbol");
                    case 1: throw ParseUtility.GenerateMissingPropertyException(objName, "total quantity");
                    case 2: throw ParseUtility.GenerateMissingPropertyException(objName, "timestamp");
                    default: throw ParseUtility.GenerateMissingPropertyException(objName, $"unknown {missingPropNum}");
                }
            }
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
            {
                ...
                if (!validator.IsComplete())
                {
                    ...
                    switch (missingPropNum)
                    {
                        case 0: throw ParseUtility.GenerateMissingPropertyException(objName, "symbol");
                        case 1: throw ParseUtility.GenerateMissingPropertyException(objName, "total quantity");
                        case 2: throw ParseUtility.GenerateMissingPropertyException(objName, "total value");
